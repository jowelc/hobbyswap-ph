...
export default function FilterBar({ filters, onChange, sort, onSortChange }: Props) {
  ...
  return (
    <div className="flex flex-col gap-2 w-full sm:flex-row sm:flex-wrap sm:items-center sm:gap-2">
      {/* 4 filter selects — 2×2 grid on mobile, inline on sm+ */}
      ...
      <div className="flex items-center gap-2 sm:contents">
        {activeCount > 0 && (
          <button
            ...
            className="text-xs text-blue-400 hover:text-blue-300 font-medium flex items-center gap-1 transition-colors whitespace-nowrap"
          >
        ...
        <div className="ml-auto sm:ml-auto flex items-center gap-1.5">
